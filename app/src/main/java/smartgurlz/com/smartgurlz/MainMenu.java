...
public class MainMenu extends ViewGroup {
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new MainMenu.LayoutParams(getContext(), attrs);
    }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
           ...
           // TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.MainMenuLP);
            //gravity = a.getInt(R.styleable.MainMenuLP_android_layout_gravity, gravity);
            //position = a.getInt(R.styleable.MainMenuLP_layout_position, position);
            //a.recycle();
        }
